...
public class Tookit {
	...
	public static Font getFont6(){
		return new Font("Î¢ÈíÑÅºÚ", Font.BOLD, 30);
	}
	public static Font getFont2(){
		return new Font("Î¢ÈíÑÅºÚ", Font.BOLD, 20) ;
	}
	public static Font getFont3(){
		return new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 18) ;
	}
	public static Font getFont4(){
		return new Font("Î¢ÈíÑÅºÚ", Font.BOLD, 18) ;
	}
	public static Font getFont5(){
		return new Font("Î¢ÈíÑÅºÚ", Font.BOLD, 24) ;
	}
